...
public class ArrayUtils {
    ...
    public static ArrayList getImageUrlList(List<String> fromServerList){
        ArrayList<String> list = new ArrayList<>();
        for(String serevImage:fromServerList){
//            list.add(URLUtil.builderImgUrl(serevImage,750,1334));
        }
        return list;
    }
    public static  <T> ArrayList<T> asList(T[] src){
